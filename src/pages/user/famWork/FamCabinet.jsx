...
import Inbox from '../cabinet/inbox/Inbox'
import Vacancies from '../cabinet/vacancies/Vacancies'
import MyVacancies from '../cabinet/MyVacancies'
import Statistics from '../cabinet/stats/Statistics'
import VacancyAdd from '../cabinet/vacancyAdd/VacancyAdd'
import StatisticsOfEmployed from './StatisticsOfEmployed'
                ...
                <Box sx={{ bgcolor: 'background.paper', width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', rowGap: '20px' }}>
                    <AppBar position="static">
                        ...
                        >
                            ...
                            <Tab label={t('დასაქმებულები')} {...a11yProps(2)} />
                    ...
                    <TabPanel value={value} index={2} dir={theme.direction}>
                        <StatisticsOfEmployed />
                    </TabPanel>
                    <TabPanel value={value} index={3} dir={theme.direction}>
                        <Statistics />
                    </TabPanel>
                    <TabPanel value={value} index={4} dir={theme.direction}>
                        <VacancyAdd family={true} />
                    </TabPanel>
